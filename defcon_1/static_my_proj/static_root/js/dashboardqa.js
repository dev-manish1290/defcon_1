...
var table = $('#example').DataTable( {
	...
	$('#example tbody').on('click', 'td.details-control', function () {
        ...
        if ( row.child.isShown() ) {
            ...
            cancel = "../static/images/cancel.png";
            value= '<a onclick="invalidate_analyst_ca(this,'+row.data().global_event_id+')"><img src="' +cancel+'"></a>';
...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,ca_type,exdate,grossamount,currency,record_date,payment_date){
    var someData = [
        {"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "ca_id": null, "comment":null,"qc_status": "True","admin_status": "True","analyst_status": "True","source": null, "ric": ric, "mic": mic, "isin":isin, "ca_type":ca_type, "exdate":exdate,"grossamt":grossamount,"currency":currency,"record_date":record_date,"payment_date":payment_date}
     ];
    var saved_data = JSON.parse(localStorage.getItem("updated_data"));
...
function confirm_analyst_ca(check,data){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data, "ca_id": null, "comment":null,"qc_status": "True","source": null, "ric": null, "mic": null, "isin":null, "ca_type":null, "exdate":null,"grossamt":null,"currency":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
        console.log(JSON.parse(localStorage.getItem("updated_data")));
...
function invalidate_analyst_ca(check,data){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data, "ca_id": null, "comment":null,"qc_status": "False","source": null, "ric": null, "mic": null, "isin":null, "ca_type":null, "exdate":null,"grossamt":null,"currency":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
