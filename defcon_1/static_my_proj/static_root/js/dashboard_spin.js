function format ( d ) {
    ...
    if(d.currency_tr !==null || d.record_date_tr !==null || d.payment_date_tr!==null){
        ...
        '<td id="'+d.tr_ca_id+'f6" style="white-space: normal;">' +  d.spunoff_name_tr + '</td>'+ 
        '<td id="'+d.tr_ca_id+'f6" style="white-space: normal;">' +  d.spunoff_isin_tr + '</td>'+ 
    ...
    if(d.currency_edi !==null || d.record_date_edi !==null || d.payment_date_edi!==null)
    {
        ...
        '<td id="'+d.tr_ca_id+'f4" style="white-space: normal;">' +  d.ca_type + '</td>' + 
        '<td id="'+d.tr_ca_id+'f5" style="white-space: normal;">' +  d.effective_date +'</td>' + 
        '<td id="'+d.tr_ca_id+'f6" style="white-space: normal;">' +  d.ratio_edi + '</td>'+ 
        '<td id="'+d.tr_ca_id+'f6" style="white-space: normal;">' +  d.spunoff_name_edi + '</td>'+ 
        '<td id="'+d.tr_ca_id+'f6" style="white-space: normal;">' +  d.spunoff_isin_edi + '</td>'+ 
    ...
    if(d.currency_fs !==null || d.record_date_fs !==null || d.payment_date_fs!==null){
        ...
        '<td id="'+d.tr_ca_id+'f4" style="white-space: normal;">' +  d.ca_type + '</td>' + 
        '<td id="'+d.tr_ca_id+'f5" style="white-space: normal;">' +  d.effective_date +'</td>' + 
        '<td id="'+d.tr_ca_id+'f6" style="white-space: normal;">' +  d.ratio_fs + '</td>'+ 
        '<td id="'+d.tr_ca_id+'f6" style="white-space: normal;">' +  d.spunoff_name_fs + '</td>'+ 
        '<td id="'+d.tr_ca_id+'f6" style="white-space: normal;">' +  d.spunoff_isin_fs + '</td>'+ 
...
var table = $('#example').DataTable( {
    ...
    if ((row.data().adjustment_factor_tr == row.data().adjustment_factor_edi) && (row.data().adjustment_factor_tr == row.data().adjustment_factor_fs)){
        row.data().adjustment_factor=row.data().adjustment_factor_tr;
    }
    else{
        row.data().adjustment_factor='';
    }
    document.getElementById("adjustment_factor").value = row.data().adjustment_factor;
