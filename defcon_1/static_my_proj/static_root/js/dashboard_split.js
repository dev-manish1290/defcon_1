...
var table = $('#example').DataTable( {
    ...
    "ajax": {
        ...
        "columns": [
            ...
            { "data": "ca_type" },
            { "data": "effective_date" },
            { className: "adjustment_factor",
                data: null,
            render: function ( data, type, row ) {
                if((row.adjustment_factor_edi == row.adjustment_factor_fs) && (row.adjustment_factor_fs == row.adjustment_factor_tr))
                 {
                     row.adjustment_factor=row.adjustment_factor_edi;
                    return row.adjustment_factor_edi;
                 }
                 else{
