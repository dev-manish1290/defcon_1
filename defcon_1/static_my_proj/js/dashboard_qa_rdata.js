function format ( d ) {
    ...
    '<th style="white-space: normal;">' +  'New_Value' + '</th></tr>' 
...
$('#submitCA').click(function(){
    ...
    if(i!==-1){
        ...
        if($('input[name="predata"]').val()=="default"){
           ...
           if(data_length!=0){
           var r =  confirm('Do you want to submit '+data_length+' CA with approved status?');
           if(r==true){
            var formData={
...
var table = $('#example').DataTable( {
    ...
    "ajax": {
        ...
        "columns": [
                ...
                }},
            {
                ...
                // }
                // need to verify this below condition and remove it if not in use
    ...
    if ((row.data().old_value_tr == row.data().old_value_edi) && (row.data().old_value_tr == row.data().old_value_fs)){
...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,exdate,old_value_gc,new_value_gc,record_date,payment_date,comment_admin){
    var someData = [{
        ...
        "mic": mic,
        "isin":isin, 
        "master_ca_type":master_ca_type, 
        "exdate":exdate,
        "old_value_gc":old_value_gc,
...
function newv(check,d,ca,mca){
    ...
    var someData = [
        ...
        {"master_corporate_action_id":dd,"global_event_id": d, "ca_id": ca,"analyst_status": "unknown","source": source_value, "ric": ric_value, "mic": mic_value, "isin":isin_value, "master_ca_type":catype_value, "exdate":ex_value,"old_value_gc":old_value_value,"new_value_gc":new_value_value,"record_date":record_value,"payment_date":payment_value}
     ];
...
function confirm_analyst_ca(check,data){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data, "ca_id": null, "qc_status": "True","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"old_value_gc":null,"new_value_gc":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
        console.log(JSON.parse(localStorage.getItem("updated_data")));
...
function invalidate_analyst_ca(check,data,comment_admin){
    $('input[name="predata"]').val("true");
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data,"comment": comment_admin, "ca_id": null, "qc_status": "False","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"old_value_gc":null,"new_value_gc":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
