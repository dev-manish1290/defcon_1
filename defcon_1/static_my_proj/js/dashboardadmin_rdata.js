function format ( d ) {
    ...
    if(d.tr_master_corporate_action_id !=null){
        ...
        '<td id="'+d.tr_ca_id+'f9" style="white-space: normal;">' +  d.new_value_tr +'</td></tr>'  
    }
    if(d.edi_master_corporate_action_id !=null){
        ...
        '<td id="'+d.edi_ca_id+'f9" style="white-space: normal;">' +  d.new_value_edi +'</td></tr>'  
    }
    if(d.fs_master_corporate_action_id !=null){
        ...
        table += 
            ...
            '<td id="'+d.fs_ca_id+'f9" style="white-space: normal;">' +  d.new_value_fs +'</td></tr>'  
    }
}
   table+= '</table>'
   return table;
...
var table = $('#example').DataTable( {
         ...
         {  className: "state",
            ...
            render: function ( data, type, row ) {
                ...
                if(row.uc_master_corporate_action_id != null){
                    ...
                    AddPreApproved_CA(user_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.master_ca_type,row.master_effective_date,row.old_value_uc,row.new_value_uc,row.record_date_uc,row.payment_date_uc,row.user_comment);
                    return "Pre Approved"
                    }
                }
                else{
                ...
                && ((row.tr_effective_date == row.fs_effective_date) && (row.fs_effective_date == row.edi_effective_date) && (row.tr_effective_date == row.edi_effective_date))){ 
                    ...
                    if(row.state=="Pre Approved"){
                        AddPreApproved_CA(master_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.master_ca_type,row.master_effective_date,row.old_value_tr,row.new_value_tr,row.record_date_tr,row.payment_date_tr,row.user_comment);
                    }
                    return row.state
                }
            }
    ...
    if ((row.data().new_value_tr == row.data().new_value_edi) && (row.data().new_value_tr == row.data().new_value_fs)){
        row.data().new_value_gc=row.data().new_value_tr;
    }
    else{
        row.data().new_value_gc='';
    }
    document.getElementById("New_Value").value = row.data().new_value_gc;
    ...
    $("#editform").submit(function(e) {
        ...
        var formData = {
            ...
            'ric'               : $('input[name=ric]').val(),
            'old_value_gc'             : $('input[name=Old_Value]').val(),
            'new_value_gc'             : $('input[name=New_Value]').val(),
...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,exdate,old_value_gc,new_value_gc,record_date,payment_date,comment_a){
    var someData = [
        {"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "ca_id": null, "comment":comment_a,"admin_status": "True","source": null, "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "exdate":exdate,"old_value_gc":old_value_gc,"new_value_gc":new_value_gc,"record_date":record_date,"payment_date":payment_date,"state":"Pre Approved"}
     ];
    var saved_data = JSON.parse(localStorage.getItem("updated_data"));
...
function newv(check,d,ca,mca){
    ...
    var exdate = ca+"f5";
    var Old_Value = ca+"f6";
    var recorddate = ca+"f7";
    var paymentdate = ca+"f8";
    var New_Value = ca+"f9";
    ...
    var someData = [
        ...
        {"master_corporate_action_id":dd,"global_event_id": d, "ca_id": ca, "comment":null,"analyst_status": "unknown","source": source_value, "ric": ric_value, "mic": mic_value, "isin":isin_value, "master_ca_type":catype_value, "exdate":ex_value,"old_value_gc":old_value_value,"new_value_gc":new_value_value,"record_date":record_value,"payment_date":payment_value}
     ];
...
function confirm_analyst_ca(check,data,comment_analyst){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data,"comment":comment_analyst, "ca_id": null, "admin_status": "True","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"old_value_gc":null,"new_value_gc":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
        console.log(JSON.parse(localStorage.getItem("updated_data")));
...
function invalidate_analyst_ca(check,data,comment_analyst){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data,"comment":comment_analyst, "ca_id": null,"admin_status": "False","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"old_value_gc":null,"new_value_gc":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
...
function Addcomment_ca(data){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data, "ca_id": null,"comment":comm,"admin_status":"unknown","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"old_value_gc":null,"old_value_gc":null,"record_date":null,"payment_date":null}
            ]
            var final_data = saved_data.concat(someData);
            localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
