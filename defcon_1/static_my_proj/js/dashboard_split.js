function format ( d,ca_id,e_id,a_id,r_id,p_id ) {
    ...
    if(d.uc_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.uc_ca_id+','+d.uc_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+a_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'"  title = "Modified At = '+d.uts_uc+'"></a></td>'
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_uc+'"></a></td>'
            ...
            table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.uc_ca_id+','+d.uc_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+a_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.tr_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.tr_ca_id+','+d.tr_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+a_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.tr_ca_id+','+d.tr_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+a_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.edi_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table += '<td><input type="checkbox" id="2" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.edi_ca_id+','+d.edi_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+a_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'" title = "Modified At = '+d.uts_edi+'"></a></td>' 
        }
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table += '<td><input type="checkbox" id="2" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.edi_ca_id+','+d.edi_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+a_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.fs_master_corporate_action_id !=null){
        ...
        if(d.fds_ca_status==='D'){
            ...
            imag1 = "../static/images/edit.png";
            table += '<td><input type="checkbox" id="3" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.fs_ca_id+','+d.fs_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+a_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'" title = "Modified At = '+d.uts_fds+'"></a></td>'
        }  
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table += '<td><input type="checkbox" id="3" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.fs_ca_id+','+d.fs_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+a_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')"></td>'
        }
...
var table = $('#example').DataTable( {
    ...
    "ajax": {
        ...
        "columns": [
            ...
            { className: "adjustment_factor_gc",
            "data":           data,
                "defaultContent": '',
                render: function ( data, type, row ) {
                if(row.uc_master_corporate_action_id != null){
                    return row.adjustment_factor_uc
                }
                else{
                    return row.adjustment_factor_gc
                }
                } 
                },
            { 
            ...
            render: function ( data, type, row ) {
                ...
                && (((row.adjustment_factor_edi == row.adjustment_factor_fs) && (row.adjustment_factor_fs == row.adjustment_factor_tr) && (row.adjustment_factor_tr == row.adjustment_factor_edi))
                ...
                && ((row.tr_effective_date == row.fs_effective_date) && (row.fs_effective_date == row.edi_effective_date) && (row.tr_effective_date == row.edi_effective_date)))){
                    ...
                    if(row.analyst_status){
                        if((row.tr_ca_status=="U") || (row.tr_ca_status=="D") || (row.edi_ca_status=="U") || (row.edi_ca_status=="D") || (row.fds_ca_status=="U") || (row.fds_ca_status=="D") || (row.tr_ca_status=="T") || (row.fds_ca_status=="T") || (row.edi_ca_status=="T") || (row.tr_ca_status=="P") || (row.fds_ca_status=="P") || (row.edi_ca_status=="P")){
                            if(row.master_ca_type !== null ||  row.master_effective_date !== null || row.adjustment_factor_gc !== null || row.record_date_gc !== null || row.payment_date_gc !== null){
                            AddUpdateDelete_CA(row.old_mca_id,row.gc_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.master_ca_type,row.security_name,row.adjustment_factor_gc,row.record_date_gc,row.payment_date_gc,row.master_effective_date);
...
return '<a onclick="confirm_analyst_ca(this,'+row.global_event_id+')"><img src="' +data+'"></a>&nbsp;&nbsp;<a onclick="invalidate_analyst_ca(this,'+row.global_event_id+','+row.tr_master_corporate_action_id+','+row.edi_master_corporate_action_id+','+row.fs_master_corporate_action_id+','+row.uc_master_corporate_action_id+',\'' + row.tr_ca_type + '\',\'' + row.edi_ca_type + '\',\'' + row.fs_ca_type + '\','+row.gc_ca_id+',\'' + row.master_ca_type + '\')"><img src="' +cancel+'"></a>';
            ...
            render: function ( data, type, row ) {
                ...
                if(row.uc_master_corporate_action_id != null){
                    if(row.admin_status=="False"){
                        ...
                        AddPreApproved_CA(user_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.uc_ca_type,row.security_name,row.uc_effective_date,row.adjustment_factor_uc,row.record_date_uc,row.payment_date_uc);
                        return "Pre Approved"
                    }
                }
                else{
                ...
                if(row.admin_status=="False"){
                    ...
                    if(((row.adjustment_factor_edi == row.adjustment_factor_fs) && (row.adjustment_factor_fs == row.adjustment_factor_tr) && (row.adjustment_factor_tr == row.adjustment_factor_edi))
                && ((row.payment_date_edi == row.payment_date_fs) && (row.payment_date_fs == row.payment_date_tr) && (row.payment_date_tr == row.payment_date_edi))
                && ((row.record_date_edi == row.record_date_fs) && (row.record_date_fs == row.record_date_tr) && (row.record_date_tr == row.record_date_edi))
                && ((row.tr_effective_date == row.fs_effective_date) && (row.fs_effective_date == row.edi_effective_date) && (row.tr_effective_date == row.edi_effective_date))){

                    AddPreApproved_CA(master_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.tr_ca_type,row.security_name,row.tr_effective_date,row.adjustment_factor_tr,row.record_date_tr,row.payment_date_tr);
    ...
    var adjst = row.data().adjustment_factor_gc;
    ...
    adjustment_var = $(this).closest('td').siblings('td.adjustment_factor_gc');
    ...
    if(i===-1){
        document.getElementById("adjustment_factorAmt").value = adjst;   
        document.getElementById("RecordDate").value = rdate;
        document.getElementById("PaymentDate").value = pdate;
        
    }
    else{
        document.getElementById("adjustment_factorAmt").value = saved_data[i].adjustment_factor;   
    ...
    $("#editform").submit(function(e) {
        ...
        var someData = [
            {"master_corporate_action_id":$('input[name=master_id]').val(), "security_name":$('input[name=Name]').val(),"global_event_id":Number($('input[name=id]').val()), "ca_id": null, "comment":$('input[name=comments]').val(),"analyst_status": "unknown","source": null, "ric": $('input[name=ric]').val(), "mic": $('input[name=mic]').val(), "isin":$('input[name=isin]').val(), "master_ca_type":null, "exdate":null,"adjustment_factor":$('input[name=adjustment_factorAmt]').val(),"record_date":$('input[name=RecordDate]').val(),"payment_date":$('input[name=PaymentDate]').val(),"state":"Pending Approval"}
         ];
        var saved_data = JSON.parse(localStorage.getItem("updated_data"));
        ...
        if(i===-1){
            ...
            saved_data[i].adjustment_factor=$('input[name=adjustment_factorAmt]').val()
            console.log(saved_data[i].adjustment_factor)
        ...
        adjustment_var.html('<h8>' +$('input[name=adjustment_factorAmt]').val()+'</h8>');
    ...
    $('#example tbody').on('click', 'td.details-control', function () {
        ...
        if ( row.child.isShown() ) {
            ...
            if(i!==-1){
                ...
                if(r == true){
                    $(this).closest('td').siblings('td.adjustment_factor_gc').html('<h8></h8>');
            ...
            if(((row.data().adjustment_factor_edi == row.data().adjustment_factor_fs) && (row.data().adjustment_factor_fs == row.data().adjustment_factor_tr) && (row.data().adjustment_factor_tr == row.data().adjustment_factor_edi))
            ...
            if(i!==-1){
                ...
                if(r == true){
                    ...
                    if(row.data().admin_status){
                        ...
                        $(this).closest('td').siblings('td.adjustment_factor_gc').html('<h8>'+row.data().adjustment_factor_gc+'</h8>');
            ...
            $(this).closest('td').siblings('td.status').html(value);
            var a_id = row.data().global_event_id + 'v1';
            ...
            $(this).closest('td').siblings('td.adjustment_factor_gc').attr('id',a_id);
            ...
            row.child(format(row.data(),ca_id,e_id,a_id,r_id,p_id)).show();
            tr.addClass('shown');
        }
    } );
...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,security_name,exdate,grossamount,record_date,payment_date){
   
    var someData = [
        {"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "security_name": security_name, "comment":null,"analyst_status": "True", "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "master_effective_date":exdate,"adjustment_factor":grossamount,"record_date":record_date,"payment_date":payment_date,"state":"Pre Approved"}
...
function AddUpdateDelete_CA(old_mca_id,master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,security_name,grossamount,record_date,payment_date,effective_date){
   
    var someData = [
        {"old_master_corporate_action_id":old_mca_id,"master_effective_date":effective_date,"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "security_name": security_name, "comment":null,"analyst_status": "undefined", "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "adjustment_factor":grossamount,"record_date":record_date,"payment_date":payment_date,"state":"Pending Action"}
     ];
    var saved_data = JSON.parse(localStorage.getItem("updated_data"));
    var i=saved_data.findIndex(item=>item.global_event_id===global_id);
    if(i===-1){
...
function newv(check,d,ca,mca,security_name,ca_id,e_id,a_id,r_id,p_id,gc_ca_id){
    $('input[name="predata"]').val("true");
    ...
    var exdate = ca+"f5";
    var adjustment_factorAmt = ca+"f6";
    ...
    var adjustment_factor_value = document.getElementById(adjustment_factorAmt).innerHTML;
    ...
    document.getElementById(a_id).innerHTML='<h8>'+adjustment_factor_value+'</h8>';
    document.getElementById(r_id).innerHTML='<h8>'+record_value+'</h8>';
    document.getElementById(p_id).innerHTML='<h8>'+payment_value+'</h8>';
    document.getElementById("adjustment_factorAmt").value = adjustment_factor_value;   
    ...
    var someData = [
        ...
        {"old_master_corporate_action_id":gc_ca_id,"master_corporate_action_id":dd,"global_event_id": d, "ca_id": ca,"comment":null, "analyst_status": "unknown","source": source_value, "ric": ric_value, "mic": mic_value, "isin":isin_value, "master_ca_type":catype_value,"security_name": security_name,"master_effective_date":ex_value,"adjustment_factor":adjustment_factor_value,"record_date":record_value,"payment_date":payment_value}
    ...
    if($(check).prop("checked") == false)
    {
        ...
        document.getElementById(a_id).innerHTML='<h8></h8>';
