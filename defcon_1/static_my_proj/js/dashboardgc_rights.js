function format ( d ) {
    ...
    '<th style="white-space: normal;">' +  'OfferedPrice' + '</th>'+
...
var table = $('#example').DataTable( {
    ...
    "ajax": {
        ...
        "columns": [
                        ...
                        }},
            {
                ...
                render: function ( data, type, row ) {
                    if(row.uc_master_corporate_action_id != null){
                        if(row.qc_status=="True"){
                            AddPreApproved_CA(row.uc_master_corporate_action_id,row.global_event_id,row.ric,row.mic,row.isin,row.master_ca_type,row.master_effective_date,row.ratio_uc,row.offered_price_uc,row.start_subscription_uc,row.end_subscription_uc,row.currency_uc,row.record_date_uc,row.payment_date_uc,row.user_comment);
                    }
                ...
                // }
                 if(row.qc_status=="True"){
                            AddPreApproved_CA(row.tr_master_corporate_action_id,row.global_event_id,row.ric,row.mic,row.isin,row.master_ca_type,row.master_effective_date,row.ratio_tr,row.offered_price_tr,row.start_subscription_tr,row.end_subscription_tr,row.currency_tr,row.record_date_tr,row.payment_date_tr,row.user_comment);
                        }
                return '<h8>Approved</h8>';
                    }
            },
         ...
         {  className: "state",
            ...
            render: function ( data, type, row ) {
                ...
                if (row.state == null){
                    if(((row.ratio_edi == row.ratio_fs) && (row.ratio_fs == row.ratio_tr) && (row.ratio_tr == row.ratio_edi))
    ...
    document.getElementById("offered_price").value = row.data().offered_price_gc;
...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,exdate,ratio_gc,offered_price_gc,start_subscription_gc,end_subscription_gc,currency,record_date,payment_date,comment_qc){
    var someData = [
        {"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "ca_id": null, "comment":comment_qc, "qc_status": "True", "source": null, "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "exdate":exdate,"ratio_gc":ratio_gc,"offered_price_gc":offered_price_gc,"start_subscription_gc":start_subscription_gc,"end_subscription_gc":end_subscription_gc,"currency":currency,"record_date":record_date,"payment_date":payment_date,"state":"Pre Approved"}
     ];
    var saved_data = JSON.parse(localStorage.getItem("updated_data"));
...
function confirm_analyst_ca(check,data){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data, "ca_id": null, "qc_status": "True","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"ratio_gc":null,"offered_price_gc":null,"start_subscription_gc":null,"end_subscription_gc":null,"currency":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
        console.log(JSON.parse(localStorage.getItem("updated_data")));
...
function invalidate_analyst_ca(check,data,comment_qc){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data,"comment": comment_qc, "ca_id": null, "qc_status": "False","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"ratio_gc":null,"offered_price_gc":null,"start_subscription_gc":null,"end_subscription_gc":null,"currency":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
...
function Addcomment_ca(data){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data, "ca_id": null,"qc_status":"True","comment":comm,"source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"ratio_gc":null,"offered_price_gc":null,"start_subscription_gc":null,"end_subscription_gc":null,"currency":null,"record_date":null,"payment_date":null}
            ]
            var final_data = saved_data.concat(someData);
            localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
