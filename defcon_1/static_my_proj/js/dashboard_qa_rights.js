...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,exdate,ratio_gc,offered_price_gc,start_subscription_gc,end_subscription_gc,currency,record_date,payment_date,comment_admin){
    var someData = [{
        ...
        "exdate":exdate,
        "ratio_gc":ratio_gc,
        "offered_price_gc":offered_price_gc,
        "start_subscription_gc":start_subscription_gc,
        "end_subscription_gc":end_subscription_gc,
        "currency":currency,
...
function invalidate_analyst_ca(check,data,comment_admin){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data,"comment": comment_admin, "ca_id": null, "qc_status": "False","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"ratio_gc":null,"offered_price_gc":null,"start_subscription_gc":null,"end_subscription_gc":null,"currency":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
...
function Addcomment_ca(data){
    ...
    if(i!==-1){
        ...
        var someData = [{
            ...
            "exdate":null,
            "ratio_gc":null,
            "offered_price_gc":null,
            "start_subscription_gc":null,
            "end_subscription_gc":null,
            "currency":null,
            "record_date":null,
            "payment_date":null
        }]
