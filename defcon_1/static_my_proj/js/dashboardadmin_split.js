         ...
         {  className: "state",
            ...
            render: function ( data, type, row ) {
                ...
                if(row.uc_master_corporate_action_id != null){
                    ...
                    AddPreApproved_CA(user_ca_id,row.global_event_id,
                ...
                if (row.state == null){
                    ...
                    if(row.state=="Pre Approved"){
                        AddPreApproved_CA(row.tr_master_corporate_action_id,row.global_event_id,
                            row.ric,row.mic,row.isin,row.master_ca_type,row.master_effective_date,row.gross_amount_tr,
                            row.record_date_tr,row.payment_date_tr,row.user_comment);
                    }
                    return row.state
                }
            }
...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,exdate,grossamount,record_date,payment_date,comment_a){
    var someData = [
        {"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "ca_id": null, "comment":comment_a,"admin_status": "True","source": null, "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "exdate":exdate,"grossamt":grossamount,"record_date":record_date,"payment_date":payment_date,"state":"Pre Approved"}
     ];
    var saved_data = JSON.parse(localStorage.getItem("updated_data"));
...
function newv(check,d,ca,mca){
    ...
    var someData = [
        ...
        {"master_corporate_action_id":dd,"global_event_id": d, "ca_id": ca, "comment":null,"analyst_status": "unknown","source": source_value, "ric": ric_value, "mic": mic_value, "isin":isin_value, "master_ca_type":catype_value, "exdate":ex_value,"grossamt":gross_value,"record_date":record_value,"payment_date":payment_value}
     ];
...
function confirm_analyst_ca(check,data,comment_analyst){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data,"comment":comment_analyst, "ca_id": null, "admin_status": "True","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"grossamt":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
        console.log(JSON.parse(localStorage.getItem("updated_data")));
...
function invalidate_analyst_ca(check,data,comment_analyst){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data,"comment":comment_analyst, "ca_id": null,"admin_status": "False","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"grossamt":null,"record_date":null,"payment_date":null}
         ];
         var final_data = saved_data.concat(someData);
        localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
...
function Addcomment_ca(data){
    ...
    if(i!==-1){
        ...
        var someData = [
            {"global_event_id": data, "ca_id": null,"comment":comm,"admin_status":"unknown","source": null, "ric": null, "mic": null, "isin":null, "master_ca_type":null, "exdate":null,"grossamt":null,"record_date":null,"payment_date":null}
            ]
            var final_data = saved_data.concat(someData);
            localStorage.setItem("updated_data",JSON.stringify(final_data));
    }
