function format ( d,ca_id,e_id,g_id,c_id,r_id,p_id ) {
    ...
    if(d.uc_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.uc_ca_id+','+d.uc_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+g_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'"  title = "Modified At = '+d.uts_uc+'"></a></td>'
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_uc+'"></a></td>'
            ...
            table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.uc_ca_id+','+d.uc_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+g_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.tr_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.tr_ca_id+','+d.tr_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+g_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.tr_ca_id+','+d.tr_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+g_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.edi_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table += '<td><input type="checkbox" id="2" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.edi_ca_id+','+d.edi_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+g_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'" title = "Modified At = '+d.uts_edi+'"></a></td>' 
        }
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table += '<td><input type="checkbox" id="2" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.edi_ca_id+','+d.edi_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+g_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.fs_master_corporate_action_id !=null){
        ...
        if(d.fds_ca_status==='D'){
            ...
            imag1 = "../static/images/edit.png";
            table += '<td><input type="checkbox" id="3" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.fs_ca_id+','+d.fs_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+g_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'" title = "Modified At = '+d.uts_fds+'"></a></td>'
        }  
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table += '<td><input type="checkbox" id="3" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.fs_ca_id+','+d.fs_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+g_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    "ajax": {
        ...
        "columns": [
            ...
            "data":           data,
                ...
                render: function ( data, type, row ) {
                if(row.uc_master_corporate_action_id != null){
                    return row.gross_amount_uc
                }
                else{
                    return row.gross_amount_gc
                }
                } 
                },
            {   className: "currency",
            ...
            render: function ( data, type, row ) {
                ...
                && (((row.gross_amount_edi == row.gross_amount_fs) && (row.gross_amount_fs == row.gross_amount_tr) && (row.gross_amount_tr == row.gross_amount_edi))
                ...
                && ((row.tr_effective_date == row.fs_effective_date) && (row.fs_effective_date == row.edi_effective_date) && (row.tr_effective_date == row.edi_effective_date)))){
                    ...
                    if(row.analyst_status){
                        if((row.tr_ca_status=="U") || (row.tr_ca_status=="D") || (row.edi_ca_status=="U") || (row.edi_ca_status=="D") || (row.fds_ca_status=="U") || (row.fds_ca_status=="D") || (row.tr_ca_status=="T") || (row.fds_ca_status=="T") || (row.edi_ca_status=="T") || (row.tr_ca_status=="P") || (row.fds_ca_status=="P") || (row.edi_ca_status=="P")){
                            if(row.master_ca_type !== null ||  row.master_effective_date !== null || row.gross_amount_gc !== null ||  row.currency_gc !== null ||  row.record_date_gc !== null || row.payment_date_gc !== null){
                            AddUpdateDelete_CA(row.old_mca_id,row.gc_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.master_ca_type,row.security_name,row.gross_amount_gc,row.currency_gc,row.record_date_gc,row.payment_date_gc,row.master_effective_date);
...
return '<a onclick="confirm_analyst_ca(this,'+row.global_event_id+')"><img src="' +data+'"></a>&nbsp;&nbsp;<a onclick="invalidate_analyst_ca(this,'+row.global_event_id+','+row.tr_master_corporate_action_id+','+row.edi_master_corporate_action_id+','+row.fs_master_corporate_action_id+','+row.uc_master_corporate_action_id+',\'' + row.tr_ca_type + '\',\'' + row.edi_ca_type + '\',\'' + row.fs_ca_type + '\','+row.gc_ca_id+',\'' + row.master_ca_type + '\')"><img src="' +cancel+'"></a>';
         ...
         {  className: "state",
            ...
            render: function ( data, type, row ) {
                ...
                if(row.uc_master_corporate_action_id != null){
                    ...
                    AddPreApproved_CA(user_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.uc_ca_type,row.security_name,row.gross_amount_uc,row.currency_uc,row.record_date_uc,row.payment_date_uc,row.uc_effective_date);
                    return "Pre Approved"
                    }
                }
                else{
                ...
                && ((row.currency_edi == row.currency_fs) && (row.currency_fs == row.currency_tr) && (row.currency_tr == row.currency_edi))
                && ((row.tr_effective_date == row.fs_effective_date) && (row.fs_effective_date == row.edi_effective_date) && (row.tr_effective_date == row.edi_effective_date))){
                    AddPreApproved_CA(master_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.tr_ca_type,row.security_name,row.gross_amount_tr,row.currency_tr,row.record_date_tr,row.payment_date_tr,row.tr_effective_date);
                    return "Pre Approved"
                    }
                    else{
    ...
    var gamnt = row.data().gross_amount_gc;
    ...
    gross_var = $(this).closest('td').siblings('td.gross_amount');
    ...
    if(i===-1){
        document.getElementById("GrossAmt").value = gamnt;
    ...
    document.getElementById("GrossAmt").value = saved_data[i].grossamt;   
    ...
    $("#editform").submit(function(e) {
        ...
        if(i===-1){
            ...
            saved_data[i].grossamt=$('input[name=grossamt]').val()
        ...
        gross_var.html('<h8>' +$('input[name=grossamt]').val()+'</h8>');
    ...
    $('#example tbody').on('click', 'td.details-control', function () {
        ...
        if ( row.child.isShown() ) {
            ...
            if(i!==-1){
                ...
                if(r == true){
                    $(this).closest('td').siblings('td.gross_amount').html('<p></p>');
                    $(this).closest('td').siblings('td.currency').html('<p></p>');
                    $(this).closest('td').siblings('td.record_date').html('<p></p>');
                    $(this).closest('td').siblings('td.payment_date').html('<p></p>');
            ...
            if(((row.data().gross_amount_edi == row.data().gross_amount_fs) && (row.data().gross_amount_fs == row.data().gross_amount_tr) && (row.data().gross_amount_tr == row.data().gross_amount_edi))
            ...
            if(i!==-1){
                ...
                if(r == true){
                    ...
                    if(row.data().admin_status){
                        ...
                        $(this).closest('td').siblings('td.gross_amount').html('<h8>'+row.data().gross_amount_gc+'</h8>');
                        ...
                        $(this).closest('td').siblings('td.currency').html('<h8>'+row.data().currency_gc+'</h8>');
                        $(this).closest('td').siblings('td.record_date').html('<h8>'+row.data().record_date_gc+'</h8>');
                        $(this).closest('td').siblings('td.payment_date').html('<h8p>'+row.data().payment_date_gc+'</h8>');
                    }
                    ...
                    // else if((row.data().tr_ca_status==='C') || (row.data().edi_ca_status==='C') || (row.data().fds_ca_status==='C')){
                    //     $(this).closest('td').siblings('td.state').html("<h8>CA_TYPE Updated</h8>");
                    // }
                    else{
            ...
            // remove(row.data().global_event_id);
            if((row.data().tr_ca_status==='U') || (row.data().edi_ca_status==='U') || (row.data().fds_ca_status==='U')){
                data = "../static/images/ok.jpg";
                cancel = "../static/images/cancel.png";
                value= '<a onclick="confirm_analyst_ca(this,'+row.global_event_id+')"><img src="' +data+'"></a>&nbsp;&nbsp;<a onclick="invalidate_analyst_ca(this,'+row.global_event_id+','+row.tr_master_corporate_action_id+','+row.edi_master_corporate_action_id+','+row.fs_master_corporate_action_id+','+row.uc_master_corporate_action_id+',\'' + row.tr_ca_type + '\',\'' + row.edi_ca_type + '\',\'' + row.fs_ca_type + '\','+row.gc_ca_id+',\'' + row.master_ca_type + '\')"><img src="' +cancel+'"></a>';
                $(this).closest('td').siblings('td.status').html(value);
            ...
            $(this).closest('td').siblings('td.status').html(value);
            var g_id = row.data().global_event_id + 'v0';
            var c_id = row.data().global_event_id + 'v1';
            ...
            $(this).closest('td').siblings('td.gross_amount').attr('id',g_id);
            ...
            row.child(format(row.data(),ca_id,e_id,g_id,c_id,r_id,p_id)).show();
            tr.addClass('shown');
        }
    } );
...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,security_name,grossamount,currency,record_date,payment_date,effective_date){
   
    var someData = [
        {"master_effective_date":effective_date,"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "security_name": security_name, "comment":null,"analyst_status": "True", "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "grossamt":grossamount,"currency":currency,"record_date":record_date,"payment_date":payment_date,"state":"Pre Approved"}
     ];
    var saved_data = JSON.parse(localStorage.getItem("updated_data"));
...
function AddUpdateDelete_CA(old_mca_id,master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,security_name,grossamount,currency,record_date,payment_date,effective_date){

    var someData = [
        {"old_master_corporate_action_id":old_mca_id,"master_effective_date":effective_date,"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "security_name": security_name, "comment":null,"analyst_status": "undefined", "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "grossamt":grossamount,"currency":currency,"record_date":record_date,"payment_date":payment_date,"state":"Pending Action"}
     ];
    var saved_data = JSON.parse(localStorage.getItem("updated_data"));
    var i=saved_data.findIndex(item=>item.global_event_id===global_id);
    if(i===-1){
...
function newv(check,d,ca,mca,security_name,ca_id,e_id,g_id,c_id,r_id,p_id,gc_ca_id){
    $('input[name="predata"]').val("true");
    ...
    document.getElementById(g_id).innerHTML='<h8>'+gross_value+'</h8>';
    ...
    document.getElementById("compare_id").value = d;
    document.getElementById("GrossAmt").value = gross_value;   
    ...
    if($(check).prop("checked") == false)
    {
        ...
        document.getElementById(g_id).innerHTML='<h8></h8>';
