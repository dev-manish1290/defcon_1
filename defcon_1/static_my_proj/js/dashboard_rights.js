function format ( d ,ca_id,e_id,ratio_id,price_id,c_id,r_id,p_id,start_id,end_id) {
    ...
    '<th style="white-space: normal;">' +  'Offered Price' + '</th>'+
    '<th style="white-space: normal;">' +  'start_subscription_gc' + '</th>' + 
    '<th style="white-space: normal;">' +  'end_subscription_gc' + '</th>' + 
    ...
    if(d.uc_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.uc_ca_id+','+d.uc_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+ratio_id+'\',\''+price_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\',\''+start_id+'\',\''+end_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'"  title = "Modified At = '+d.uts_uc+'"></a></td>'
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_uc+'"></a></td>'
            ...
            table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.uc_ca_id+','+d.uc_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+ratio_id+'\',\''+price_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\',\''+start_id+'\',\''+end_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.tr_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.tr_ca_id+','+d.tr_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+ratio_id+'\',\''+price_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\',\''+start_id+'\',\''+end_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table +='<td><input type="checkbox" id="1" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.tr_ca_id+','+d.tr_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+ratio_id+'\',\''+price_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\',\''+start_id+'\',\''+end_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.edi_master_corporate_action_id !=null){
        ...
        imag1 = "../static/images/edit.png";
         table += '<td><input type="checkbox" id="2" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.edi_ca_id+','+d.edi_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+ratio_id+'\',\''+price_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\',\''+start_id+'\',\''+end_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'" title = "Modified At = '+d.uts_edi+'"></a></td>' 
        }
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table += '<td><input type="checkbox" id="2" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.edi_ca_id+','+d.edi_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+ratio_id+'\',\''+price_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\',\''+start_id+'\',\''+end_id+'\','+d.gc_ca_id+')"></td>'
        }
    ...
    if(d.fs_master_corporate_action_id !=null){
        ...
        if(d.fds_ca_status==='D'){
            ...
            imag1 = "../static/images/edit.png";
            table += '<td><input type="checkbox" id="3" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.fs_ca_id+','+d.fs_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+ratio_id+'\',\''+price_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\',\''+start_id+'\',\''+end_id+'\','+d.gc_ca_id+')">&nbsp;&nbsp;<a><img src="' +imag1+'" title = "Modified At = '+d.uts_fds+'"></a></td>'
        }  
         ...
         table +='<td><a><img src="' +imag1+'"  title = "Modified At = '+d.uts_tr+'"></a></td>'
            ...
            table += '<td><input type="checkbox" id="3" name="'+d.global_event_id+'" onclick="newv(this,'+d.global_event_id+','+d.fs_ca_id+','+d.fs_master_corporate_action_id+',\'' + d.security_name + '\',\''+ca_id+'\',\''+e_id+'\',\''+ratio_id+'\',\''+price_id+'\',\''+c_id+'\',\''+r_id+'\',\''+p_id+'\',\''+start_id+'\',\''+end_id+'\','+d.gc_ca_id+')"></td>'
        }
...
var offeredprice_var;
var ratio_var;
var start_subscription_var;
var end_subscription_var;
var cuurency_var;
var name_var;
var status_var;
var state_var;
    ...
    "ajax": {
        ...
        "columns": [
            ...
            {   className: "ratio_gc",
                ...
                {   className: "offered_price_gc",
                "data":           data,
                "defaultContent": '',
                render: function ( data, type, row ) {
                if(row.uc_master_corporate_action_id != null){
                    return row.offered_price_uc
                }
                else{
                    return row.offered_price_gc
                }
                } 
                },
            {   className: "currency",
            ...
            render: function ( data, type, row ) {
            if(row.uc_master_corporate_action_id != null){
                return row.currency_uc
            }
            else{
                return row.currency_gc
            }
            } },
            { 
            ...
            {   className: "start_subscription_gc",
            "data":           data,
            "defaultContent": '',
            render: function ( data, type, row ) {
            if(row.uc_master_corporate_action_id != null){
                return row.start_subscription_uc
            }
            else{
                return row.start_subscription_gc
            }
            } },
            {   className: "end_subscription_gc",
            "data":           data,
            "defaultContent": '',
            render: function ( data, type, row ) {
            if(row.uc_master_corporate_action_id != null){
                return row.end_subscription_uc
            }
            else{
                return row.end_subscription_gc
            }
            } },    
            {
                className: "status",
            render: function ( data, type, row ) {
                ...
                && (((row.start_subscription_edi == row.start_subscription_fs) && (row.start_subscription_fs == row.start_subscription_tr) && (row.start_subscription_tr == row.start_subscription_edi))
                && ((row.end_subscription_edi == row.end_subscription_fs) && (row.end_subscription_fs == row.end_subscription_tr) && (row.end_subscription_tr == row.end_subscription_edi))
                ...
                && ((row.tr_effective_date == row.fs_effective_date) && (row.fs_effective_date == row.edi_effective_date) && (row.tr_effective_date == row.edi_effective_date)))){
                    ...
                    if(row.analyst_status){
                        if((row.tr_ca_status=="U") || (row.tr_ca_status=="D") || (row.edi_ca_status=="U") || (row.edi_ca_status=="D") || (row.fds_ca_status=="U") || (row.fds_ca_status=="D") || (row.tr_ca_status=="T") || (row.fds_ca_status=="T") || (row.edi_ca_status=="T") || (row.tr_ca_status=="P") || (row.fds_ca_status=="P") || (row.edi_ca_status=="P")){
                            if(row.master_ca_type !== null ||  row.master_effective_date !== null || row.ratio_gc !== null || row.currency_gc !== null || row.offered_price_gc !== null || row.start_subscription_gc !== null || row.end_subscription_gc !== null || row.record_date_gc !== null || row.payment_date_gc !== null){
                                AddUpdateDelete_CA(row.old_mca_id,row.gc_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.master_ca_type,row.security_name,row.ratio_gc,row.offered_price_gc,row.start_subscription_gc,row.end_subscription_gc,row.currency_gc,row.record_date_gc,row.payment_date_gc,row.master_effective_date);
...
return '<a onclick="confirm_analyst_ca(this,'+row.global_event_id+')"><img src="' +data+'"></a>&nbsp;&nbsp;<a onclick="invalidate_analyst_ca(this,'+row.global_event_id+','+row.tr_master_corporate_action_id+','+row.edi_master_corporate_action_id+','+row.fs_master_corporate_action_id+','+row.uc_master_corporate_action_id+',\'' + row.tr_ca_type + '\',\'' + row.edi_ca_type + '\',\'' + row.fs_ca_type + '\','+row.gc_ca_id+',\'' + row.master_ca_type + '\')"><img src="' +cancel+'"></a>';
         ...
         {  className: "state",
            ...
            render: function ( data, type, row ) {
                ...
                if(row.uc_master_corporate_action_id != null){
                    ...
                    AddPreApproved_CA(user_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.uc_ca_type,row.security_name,row.uc_effective_date,row.ratio_uc,row.offered_price_uc,row.start_subscription_uc,row.end_subscription_uc,row.currency_uc,row.record_date_uc,row.payment_date_uc);
                    return "Pre Approved"
                    }
                }
                else{
                ...
                if(row.admin_status=="False"){
                    ...
                    if(((row.start_subscription_edi == row.start_subscription_fs) && (row.start_subscription_fs == row.start_subscription_tr) && (row.start_subscription_tr == row.start_subscription_edi))
                && ((row.end_subscription_edi == row.end_subscription_fs) && (row.end_subscription_fs == row.end_subscription_tr) && (row.end_subscription_tr == row.end_subscription_edi))
                && ((row.payment_date_edi == row.payment_date_fs) && (row.payment_date_fs == row.payment_date_tr) && (row.payment_date_tr == row.payment_date_edi))
                && ((row.ratio_edi == row.ratio_fs) && (row.ratio_fs == row.ratio_tr) && (row.ratio_tr == row.ratio_edi))
                && ((row.offered_price_edi == row.offered_price_fs) && (row.offered_price_fs == row.offered_price_tr) && (row.offered_price_tr == row.offered_price_edi))
                ...
                && ((row.currency_edi == row.currency_fs) && (row.currency_fs == row.currency_tr) && (row.currency_tr == row.currency_edi))
                && ((row.tr_effective_date == row.fs_effective_date) && (row.fs_effective_date == row.edi_effective_date) && (row.tr_effective_date == row.edi_effective_date))){
                    AddPreApproved_CA(master_ca_id,row.global_event_id,row.ric,row.mic,row.isin,row.tr_ca_type,row.security_name,row.tr_effective_date,row.ratio_tr,row.offered_price_tr,row.start_subscription_tr,row.end_subscription_tr,row.currency_tr,row.record_date_tr,row.payment_date_tr);
                    return "Pre Approved"
                    }
                    else{
    ...
    var ofprice = row.data().offered_price_gc;
    var stsub = row.data().start_subscription_gc;
    var endsub = row.data().end_subscription_gc;
    var rdate = row.data().record_date_gc;
    var pdate = row.data().payment_date_gc;
    var crncy = row.data().currency_gc;
    var analyst= $('input[name=analyst]').val();
    ...
    offeredprice_var = $(this).closest('td').siblings('td.offered_price_gc');
    start_subscription_var = $(this).closest('td').siblings('td.start_subscription_gc');
    end_subscription_var = $(this).closest('td').siblings('td.end_subscription_gc');
    ...
    if(i===-1){
        ...
        document.getElementById("offeredprice").value = ofprice;
        document.getElementById("StartSubscription").value = stsub;
        document.getElementById("EndSubscription").value = endsub;
        document.getElementById("Currency").value = crncy;
        document.getElementById("RecordDate").value = rdate;
        document.getElementById("PaymentDate").value = pdate;
        
    }
    else{
        document.getElementById("ratio").value = saved_data[i].ratios;
        document.getElementById("offeredprice").value = saved_data[i].offered_price;
        document.getElementById("StartSubscription").value = saved_data[i].start_subscription;
        document.getElementById("EndSubscription").value = saved_data[i].end_subscription;
        document.getElementById("Currency").value = saved_data[i].currency;
    ...
    $("#editform").submit(function(e) {
        ...
        var someData = [
            {"master_corporate_action_id":$('input[name=master_id]').val(),"global_event_id":Number($('input[name=id]').val()), "security_name":$('input[name=Name]').val(), "ratios":$('input[name=ratio]').val(), "offered_price":$('input[name=offeredprice]').val(), "comment":$('input[name=comments]').val(),"analyst_status": "unknown", "ric": $('input[name=ric]').val(), "mic": $('input[name=mic]').val(), "isin":$('input[name=isin]').val(), "start_subscription":$('input[name=StartSubscription]').val(),"end_subscription":$('input[name=EndSubscription]').val(),"currency":$('input[name=currency]').val(),"record_date":$('input[name=RecordDate]').val(),"payment_date":$('input[name=PaymentDate]').val(),"state":"Pending Approval"}
         ];
        var saved_data = JSON.parse(localStorage.getItem("updated_data"));
        ...
        if(i===-1){
            ...
            saved_data[i].offered_price=$('input[name=offeredprice]').val()
            saved_data[i].start_subscription=$('input[name=StartSubscription]').val()
            saved_data[i].end_subscription=$('input[name=EndSubscription]').val()
            saved_data[i].currency=$('input[name=currency]').val()
        ...
        offeredprice_var.html('<h8>' +$('input[name=offeredprice]').val()+'</h8>');
        start_subscription_var.html('<h8>' +$('input[name=StartSubscription]').val()+'</h8>');
        end_subscription_var.html('<h8>' +$('input[name=EndSubscription]').val()+'</h8>');
        ...
        if ( row.child.isShown() ) {
            ...
            if(i!==-1){
                ...
                if(r == true){
                    ...
                    $(this).closest('td').siblings('td.offered_price_gc').html('<h8></h8>');
                    $(this).closest('td').siblings('td.currency').html('<h8></h8>');
                    $(this).closest('td').siblings('td.start_subscription_gc').html('<h8></h8>');
                    $(this).closest('td').siblings('td.end_subscription_gc').html('<h8></h8>');
            ...
            if(((row.data().start_subscription_edi == row.data().start_subscription_fs) && (row.data().start_subscription_fs == row.data().start_subscription_tr) && (row.data().start_subscription_tr == row.data().start_subscription_edi))
                && ((row.data().end_subscription_edi == row.data().end_subscription_fs) && (row.data().end_subscription_fs == row.data().end_subscription_tr) && (row.data().end_subscription_tr == row.data().end_subscription_edi))
                ...
                && ((row.data().offered_price_edi == row.data().offered_price_fs) && (row.data().offered_price_fs == row.data().offered_price_tr) && (row.data().offered_price_tr == row.data().offered_price_edi))
            ...
            if(i!==-1){
                ...
                if(r == true){
                    ...
                    if(row.data().admin_status){
                        ...
                        $(this).closest('td').siblings('td.offered_price_gc').html('<h8>'+row.data().offered_price_gc+'</h8>');
                        $(this).closest('td').siblings('td.currency').html('<h8>'+row.data().currency_gc+'</h8>');
                        $(this).closest('td').siblings('td.start_subscription_gc').html('<h8>'+row.data().start_subscription_gc+'</h8>');
                        $(this).closest('td').siblings('td.end_subscription_gc').html('<h8>'+row.data().end_subscription_gc+'</h8>');
            ...
            var price_id = row.data().global_event_id + 'v6';
            var start_id = row.data().global_event_id + 'v8';
            var end_id = row.data().global_event_id + 'v9';
            var c_id = row.data().global_event_id + 'v7';
            ...
            $(this).closest('td').siblings('td.offered_price_gc').attr('id',price_id);
            $(this).closest('td').siblings('td.currency').attr('id',c_id);
            $(this).closest('td').siblings('td.start_subscription_gc').attr('id',start_id);
            $(this).closest('td').siblings('td.end_subscription_gc').attr('id',end_id);
            ...
            row.child(format(row.data(),ca_id,e_id,ratio_id,price_id,c_id,r_id,p_id,start_id,end_id)).show();
            tr.addClass('shown');
        }
    } );
...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,security_name,effective_date,ratio_gc,offered_price_gc,start_subscription_gc,end_subscription_gc,currency,record_date,payment_date){
   
    var someData = [
        {"master_effective_date":effective_date,"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "ca_id": null, "comment":null,"analyst_status": "True","ratios":ratio_gc, "offered_price":offered_price_gc, "security_name": security_name, "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "start_subscription":start_subscription_gc,"end_subscription":end_subscription_gc,"currency":currency,"record_date":record_date,"payment_date":payment_date,"state":"Pre Approved"}
...
function AddUpdateDelete_CA(old_mca_id,master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,security_name,ratio_gc,offered_price_gc,start_subscription_gc,end_subscription_gc,currency,record_date,payment_date,effective_date){
   
    var someData = [
        {"old_master_corporate_action_id":old_mca_id,"master_effective_date":effective_date,"master_corporate_action_id":master_corporate_action_id,"global_event_id": global_id, "security_name": security_name, "comment":null,"analyst_status": "undefined", "ric": ric, "mic": mic, "isin":isin, "master_ca_type":master_ca_type, "ratios":ratio_gc, "offered_price":offered_price_gc, "currency":currency,"start_subscription":start_subscription_gc,"end_subscription":end_subscription_gc,"record_date":record_date,"payment_date":payment_date,"state":"Pending Action"}
     ];
    var saved_data = JSON.parse(localStorage.getItem("updated_data"));
    var i=saved_data.findIndex(item=>item.global_event_id===global_id);
    if(i===-1){
...
function newv(check,d,ca,mca,security_name,ca_id,e_id,ratio_id,price_id,c_id,r_id,p_id,start_id,end_id,gc_ca_id){
    $('input[name="predata"]').val("true");
    ...
    document.getElementById(price_id).innerHTML='<h8>'+offeredprice_value+'</h8>';
    document.getElementById(c_id).innerHTML='<h8>'+curr_value+'</h8>';
    document.getElementById(r_id).innerHTML='<h8>'+record_value+'</h8>';
    document.getElementById(p_id).innerHTML='<h8>'+payment_value+'</h8>';
    document.getElementById(start_id).innerHTML='<h8>'+start_subscription_value+'</h8>';
    document.getElementById(end_id).innerHTML='<h8>'+end_subscription_value+'</h8>';
    var dd = document.getElementById(master_corporate).value;
    document.getElementById("ratio").value = ratio_value;
    document.getElementById("offeredprice").value = offeredprice_value;
    document.getElementById("StartSubscription").value = start_subscription_value;
    document.getElementById("EndSubscription").value = end_subscription_value;
    document.getElementById("Currency").value = curr_value;
    ...
    var someData = [
        ...
        {"old_master_corporate_action_id":gc_ca_id,"master_corporate_action_id":dd,"global_event_id": d, "ca_id": ca,"comment":null, "analyst_status": "unknown","source": source_value, "ric": ric_value, "mic": mic_value, "isin":isin_value,"ratios":ratio_value, "offered_price":offeredprice_value, "master_ca_type":catype_value,"security_name":security_name,"master_effective_date":ex_value,"start_subscription":start_subscription_value,"end_subscription":end_subscription_value,"currency":curr_value,"record_date":record_value,"payment_date":payment_value}
    ...
    if($(check).prop("checked") == false)
    {
        ...
        document.getElementById(price_id).innerHTML='<h8></h8>';
        document.getElementById(c_id).innerHTML='<h8></h8>';
        document.getElementById(r_id).innerHTML='<h8></h8>';
        document.getElementById(p_id).innerHTML='<h8></h8>';
        document.getElementById(start_id).innerHTML='<h8></h8>';
        document.getElementById(end_id).innerHTML='<h8></h8>';
        remove_ca(ca);
    }
    else{
        console.log(JSON.parse(localStorage.getItem("updated_data")));
