...
function AddPreApproved_CA(master_corporate_action_id,global_id,ric,mic,isin,master_ca_type,exdate,grossamount,record_date,payment_date,comment_admin){
    var someData = [{
